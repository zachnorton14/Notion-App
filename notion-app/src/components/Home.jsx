    ...
    return (
        <main className="homecontainer">
            ...
            <section className="aboutsection">
                <h2>About</h2>
                <p>This project started as a place where I could share all of my notes over the span of this last year. However, I thought it would be better as a notetaking app. I would just have my notes as a showcase of what's possible on this platform instead. And, as this app is basically one big globally accessible filing cabinet, I named it iArchive.</p>
